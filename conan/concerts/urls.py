...
urlpatterns = [
    ...
    path("concert/<int:pk>/extra/<int:idx>/delete/", views.extra_delete, name="extra_delete"),
    path("concert/<int:pk>/extra/<int:idx>/update/", views.extra_update, name="extra_update"),
    path("concert/<int:pk>/extra/<int:idx>/toggle/", views.extra_toggle, name="extra_toggle"),
